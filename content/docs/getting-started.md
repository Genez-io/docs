...
This guide walks you through the initial setup process in Genezio. The setup is designed to quickly create the data needed to measure your brand's AI Visibility across AI systems such as ChatGPT, Claude, Gemini, and Perplexity.
...
Topics determine the areas where Genezio will measure AI Visibility.
...
The **Prompter Agent** is an agent type where the text is sent to the LLM as a direct prompt.
...
This process builds the dataset used to calculate AI Visibility.
...
This dashboard provides a high-level view of your AI Visibility.
