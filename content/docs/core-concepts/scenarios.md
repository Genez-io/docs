...
5. Those prompts are sent to the LLM during the conversation.
...
This page explains how Genezio executes conversations and analyzes the responses generated by LLMs.
