...
- **Perceptions** — the individual claims AI engines make about your brand (see [Perceptions](../core-concepts/perceptions.html)).
...
1. Open your **brand report**.
2. Look for the **Overall AI Perception** card near the top of the page.
3. Read the summary directly, or copy it into your own document.
...
The summary also feeds the **Geo Assistant's** context. That means you can ask Geo follow-up questions about your overall AI perception and get answers grounded in the same data the card is built from. See [Geo Assistant](../geo-assistant/geo-assistant.html).
