...
* it doesn't render
* it doesn't make its API calls
* the page loads faster as a result
...
* **brand owners** can set a sensible default so every team member sees the same focused dashboard
* **individual users** can adjust their own view when they need to see something specific without changing the default for everyone
