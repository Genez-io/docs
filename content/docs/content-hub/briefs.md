...
1. Open **Content Hub**.
2. Click **New Content**.
3. Choose **Brief** as the content type.
4. Fill in the brief's fields (audience, tone, keywords, competitors, scenarios, additional instructions).
...
See [Content Hub](content-hub.html) for how templates work.
