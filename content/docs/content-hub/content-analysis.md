...
* Which pages are ready to be cited by an answer engine?
* Which ones aren't, and why?
* What specifically should you change to fix them?
...
* a **URL** — any public page on your site (or elsewhere)
* a **document** — uploaded directly
* an **existing Genezio article** — any article in your Content Hub library
...
* **Readability** — how cleanly the page reads, including sentence structure and clarity
* **Structure** — heading hierarchy, sections, lists, tables, and other signals answer engines use to navigate content
* **Claim-supporting signals** — whether claims in the content are backed by evidence answer engines can recognize (data, sources, examples)
* **Citability** — how likely an answer engine is to pick this page as a source in a response
...
* Generate or refine an article in Content Hub
* Run Content Analysis on the draft before publishing
* Apply the recommendations
* Publish, then track citation appearances on your dashboards

And with the [Geo Assistant](../geo-assistant/geo-assistant.html):

* Geo can point you at low-citability pages worth analyzing
* After analysis, you can send results to Geo for follow-up questions ("which of these recommendations would help most for topic X?")
